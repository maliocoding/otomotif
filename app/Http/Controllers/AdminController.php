...
class AdminController extends Controller
{
    ...
    public function json_barang(){
       ...
       ->addColumn('action', function ($barang) {
                                ...
                                <a href="/hapus/' .$barang->id . '" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-delete"></i> Hapus</a>';
                            })
                            ->make(true);
        }
    }
   ...
   public function proses_kat(Request $req){
    ...
    public function hapus($id){
    	...
    	$gambar= Gambar::where('id',$id)->first(); //first ambil 1 data pertama
    	//hapus file
